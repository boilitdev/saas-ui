...
import { type EditorView, DecorationSet, Decoration } from '@tiptap/pm/view'
...
function defaultFindSuggestionMatch(config: Trigger): SuggestionMatch {
 ...
 */
export default function Suggestion<I = any, TSelected = any>({
